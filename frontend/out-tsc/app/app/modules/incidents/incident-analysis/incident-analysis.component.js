...
function IncidentAnalysisComponent_li_17_Template(rf, ctx) { if (rf & 1) {
    const _r6 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "li", 14);
    i0.ɵɵlistener("click", function IncidentAnalysisComponent_li_17_Template_li_click_0_listener() { const restoredCtx = i0.ɵɵrestoreView(_r6); const i_r4 = restoredCtx.$implicit; const ctx_r5 = i0.ɵɵnextContext(); return ctx_r5.selectIncident(i_r4); });
    ...
    i0.ɵɵclassProp("active", (ctx_r0.selectedIncident == null ? null : ctx_r0.selectedIncident.id) === i_r4.id);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(i_r4.titre);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate2("", i0.ɵɵpipeBind2(8, 5, i_r4.dateSurvenance, "shortDate"), " | ", i_r4.statut, "");
} }
function IncidentAnalysisComponent_div_19_option_16_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "option", 24);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const r_r10 = ctx.$implicit;
    i0.ɵɵproperty("ngValue", r_r10.id);
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", r_r10.titre + " (Score: " + (r_r10.niveauRisque || r_r10.cotationRisqueNet || "-") + ")", " ");
} }
function IncidentAnalysisComponent_div_19_div_49_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("ngModelChange", function IncidentAnalysisComponent_div_19_div_49_Template_input_ngModelChange_3_listener($event) { const restoredCtx = i0.ɵɵrestoreView(_r13); const n_r11 = restoredCtx.$implicit; const ctx_r12 = i0.ɵɵnextContext(2); return (ctx_r12.rootCauses[n_r11 - 1] = $event); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(n_r11);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("placeholder", "Pourquoi ? (Etape " + n_r11 + ")")("ngModel", ctx_r8.rootCauses[n_r11 - 1])("disabled", ctx_r8.isReadOnlyRole);
} }
function IncidentAnalysisComponent_div_19_button_51_Template(rf, ctx) { if (rf & 1) {
    const _r15 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 46);
    i0.ɵɵlistener("click", function IncidentAnalysisComponent_div_19_button_51_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r15); const ctx_r14 = i0.ɵɵnextContext(2); return ctx_r14.saveFullAnalysis(); });
    i0.ɵɵelement(1, "i", 47);
    i0.ɵɵtext(2, " Sauvegarder l'Analyse Complete ");
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r9 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("disabled", ctx_r9.isLoading);
    i0.ɵɵadvance(1);
    i0.ɵɵclassProp("fa-save", !ctx_r9.isLoading)("fa-circle-notch", ctx_r9.isLoading)("fa-spin", ctx_r9.isLoading);
} }
const _c0 = function () { return [1, 2, 3, 4, 5]; };
function IncidentAnalysisComponent_div_19_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("ngModelChange", function IncidentAnalysisComponent_div_19_Template_select_ngModelChange_13_listener($event) { i0.ɵɵrestoreView(_r17); const ctx_r16 = i0.ɵɵnextContext(); return ctx_r16.onRiskSelectionChange($event); });
    i0.ɵɵelementStart(14, "option", 24);
    i0.ɵɵtext(15, "Selectionner un risque...");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(16, IncidentAnalysisComponent_div_19_option_16_Template, 2, 2, "option", 25);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵlistener("ngModelChange", function IncidentAnalysisComponent_div_19_Template_input_ngModelChange_25_listener($event) { i0.ɵɵrestoreView(_r17); const ctx_r18 = i0.ɵɵnextContext(); return ctx_r18.estimatedCost = $event; });
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵlistener("ngModelChange", function IncidentAnalysisComponent_div_19_Template_select_ngModelChange_29_listener($event) { i0.ɵɵrestoreView(_r17); const ctx_r19 = i0.ɵɵnextContext(); return ctx_r19.observedSeverity = $event; });
    ...
    i0.ɵɵtext(33, "Faible");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(34, "option", 32);
    i0.ɵɵtext(35, "Moyen");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(36, "option", 33);
    i0.ɵɵtext(37, "Eleve");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(38, "option", 34);
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(44, "div", 37);
    i0.ɵɵelementStart(45, "h3");
    i0.ɵɵelement(46, "i", 38);
    i0.ɵɵtext(47, " Analyse des Causes Profondes (5 Pourquoi)");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(48, "div", 39);
    i0.ɵɵtemplate(49, IncidentAnalysisComponent_div_19_div_49_Template, 4, 4, "div", 40);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(50, "div", 41);
    i0.ɵɵtemplate(51, IncidentAnalysisComponent_div_19_button_51_Template, 3, 7, "button", 42);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate1("Analyse de l'Incident : ", ctx_r1.selectedIncident.titre, "");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r1.selectedIncident.description);
    i0.ɵɵadvance(8);
    i0.ɵɵproperty("ngModel", ctx_r1.selectedRiskId)("disabled", ctx_r1.isReadOnlyRole || ctx_r1.isLoading);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngValue", null);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngForOf", ctx_r1.risks);
    i0.ɵɵadvance(9);
    i0.ɵɵproperty("ngModel", ctx_r1.estimatedCost)("disabled", ctx_r1.isReadOnlyRole);
    i0.ɵɵadvance(4);
    i0.ɵɵproperty("ngModel", ctx_r1.observedSeverity)("disabled", ctx_r1.isReadOnlyRole);
    i0.ɵɵadvance(20);
    i0.ɵɵproperty("ngForOf", i0.ɵɵpureFunction0(12, _c0));
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngIf", !ctx_r1.isReadOnlyRole);
} }
function IncidentAnalysisComponent_ng_template_20_Template(rf, ctx) { if (rf & 1) {
...
IncidentAnalysisComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: IncidentAnalysisComponent, selectors: [["app-incident-analysis"]], decls: 22, vars: 3, consts: [[1, "incident-page", "analysis-view"], [1, "page-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "fas", "fa-arrow-left"], [1, "fas", "fa-microscope"], [1, "dual-layout"], [1, "sidebar", "card"], [1, "sidebar-header"], [1, "item-list"], [3, "active", "click", 4, "ngFor", "ngForOf"], [1, "main-content", "card"], [4, "ngIf", "ngIfElse"], ["selectPrompt", ""], [3, "click"], [1, "item-icon"], [1, "fas", "fa-exclamation-circle"], [1, "item-info"], [1, "analysis-section"], [1, "description"], [1, "analysis-grid"], [1, "analysis-card", "shadow-sm"], [1, "fas", "fa-link"], [1, "premium-select", 3, "ngModel", "disabled", "ngModelChange"], [3, "ngValue"], [3, "ngValue", 4, "ngFor", "ngForOf"], [1, "fas", "fa-chart-line"], [1, "impact-fields"], [1, "i-field"], ["type", "number", "placeholder", "0.00", 1, "premium-input", 3, "ngModel", "disabled", "ngModelChange"], ["value", ""], ["value", "Faible"], ["value", "Moyen"], ["value", "Eleve"], ["value", "Critique"], ["value", "Significatif"], ["value", "Limite"], [1, "root-cause-section", "mt-4"], [1, "fas", "fa-search"], [1, "why-list"], ["class", "why-item", 4, "ngFor", "ngForOf"], [1, "analysis-actions"], ["class", "btn-save-analysis", 3, "disabled", "click", 4, "ngIf"], [1, "why-item"], [1, "num"], ["type", "text", 1, "premium-input", 3, "placeholder", "ngModel", "disabled", "ngModelChange"], [1, "btn-save-analysis", 3, "disabled", "click"], [1, "fas"], [1, "select-prompt"]], template: function IncidentAnalysisComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵtext(15, "Files d'Incidents");
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(16, "ul", 9);
        i0.ɵɵtemplate(17, IncidentAnalysisComponent_li_17_Template, 9, 8, "li", 10);
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(18, "div", 11);
        i0.ɵɵtemplate(19, IncidentAnalysisComponent_div_19_Template, 52, 13, "div", 12);
        i0.ɵɵtemplate(20, IncidentAnalysisComponent_ng_template_20_Template, 4, 0, "ng-template", null, 13, i0.ɵɵtemplateRefExtractor);
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
    } if (rf & 2) {
