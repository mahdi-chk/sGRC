...
function KpiManagementComponent_div_15_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 11);
    i0.ɵɵelement(1, "div", 12);
    i0.ɵɵelementEnd();
} }
function KpiManagementComponent_div_16_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(kpi_r3.label);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate2("", kpi_r3.value, "", kpi_r3.unit, "");
    i0.ɵɵadvance(2);
    i0.ɵɵstyleProp("width", kpi_r3.unit === "%" ? kpi_r3.value : 100, "%");
} }
function KpiManagementComponent_div_16_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 13);
    i0.ɵɵtemplate(1, KpiManagementComponent_div_16_div_1_Template, 14, 5, "div", 14);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
KpiManagementComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: KpiManagementComponent, selectors: [["app-kpi-management"]], decls: 17, vars: 5, consts: [[1, "role-dashboard", "reporting-dashboard", "kpi-page"], [1, "page-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "fas", "fa-arrow-left"], [1, "fas", "fa-tachometer-alt"], [1, "header-right"], [1, "btn-refresh", 3, "disabled", "click"], [1, "fas", "fa-sync-alt"], ["class", "loading-overlay", 4, "ngIf"], ["class", "kpi-grid", 4, "ngIf"], [1, "loading-overlay"], [1, "spinner"], [1, "kpi-grid"], ["class", "kpi-detail-card premium", 4, "ngFor", "ngForOf"], [1, "kpi-detail-card", "premium"], [1, "kpi-header"], [1, "kpi-label"], [1, "kpi-trend", "positive"], [1, "fas", "fa-caret-up"], [1, "kpi-body"], [1, "kpi-value-large"], [1, "kpi-progress-bar"], [1, "fill"], [1, "kpi-footer"], [1, "kpi-meta"]], template: function KpiManagementComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(15, KpiManagementComponent_div_15_Template, 2, 0, "div", 9);
        i0.ɵɵtemplate(16, KpiManagementComponent_div_16_Template, 2, 1, "div", 10);
        i0.ɵɵelementEnd();
    } if (rf & 2) {
        i0.ɵɵadvance(12);
