...
function MultiEntityVisionComponent_div_15_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 11);
    i0.ɵɵelement(1, "div", 12);
    i0.ɵɵelementEnd();
} }
function MultiEntityVisionComponent_div_16_tr_19_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵtextInterpolate(entity_r3.riskCount);
    i0.ɵɵadvance(2);
    i0.ɵɵclassProp("zero", entity_r3.criticalRiskCount === 0);
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate(entity_r3.criticalRiskCount);
    i0.ɵɵadvance(3);
    i0.ɵɵstyleProp("width", entity_r3.treatmentRate, "%");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", i0.ɵɵpipeBind2(14, 10, entity_r3.treatmentRate, "1.0-0"), "%");
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("ngClass", entity_r3.treatmentRate > 70 ? "high" : entity_r3.treatmentRate > 40 ? "medium" : "low");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" ", i0.ɵɵpipeBind2(19, 13, entity_r3.treatmentRate / 20, "1.1-1"), "/5 ");
} }
function MultiEntityVisionComponent_div_16_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(19, MultiEntityVisionComponent_div_16_tr_19_Template, 20, 16, "tr", 17);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
...
MultiEntityVisionComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MultiEntityVisionComponent, selectors: [["app-multi-entity-vision"]], decls: 17, vars: 5, consts: [[1, "role-dashboard", "reporting-dashboard", "multi-entity-page"], [1, "page-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "fas", "fa-arrow-left"], [1, "fas", "fa-project-diagram"], [1, "header-right"], [1, "btn-refresh", 3, "disabled", "click"], [1, "fas", "fa-sync-alt"], ["class", "loading-overlay", 4, "ngIf"], ["class", "entity-grid", 4, "ngIf"], [1, "loading-overlay"], [1, "spinner"], [1, "entity-grid"], [1, "module-card", "premium", "table-card"], [1, "fas", "fa-table"], [1, "premium-table"], [4, "ngFor", "ngForOf"], [1, "entity-name"], [1, "badge", "count"], [1, "badge", "critical"], [1, "mini-progress"], [1, "bar"], [1, "score-indicator", 3, "ngClass"], [1, "fas", "fa-star"]], template: function MultiEntityVisionComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(15, MultiEntityVisionComponent_div_15_Template, 2, 0, "div", 9);
        i0.ɵɵtemplate(16, MultiEntityVisionComponent_div_16_Template, 20, 1, "div", 10);
        i0.ɵɵelementEnd();
    } if (rf & 2) {
        i0.ɵɵadvance(12);
