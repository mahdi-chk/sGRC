...
function TreatmentPlansComponent_div_45_Template(rf, ctx) { if (rf & 1) {
...
function TreatmentPlansComponent_tr_66_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function TreatmentPlansComponent_tr_66_Template_button_click_21_listener() { const restoredCtx = i0.ɵɵrestoreView(_r7); const plan_r4 = restoredCtx.$implicit; const ctx_r6 = i0.ɵɵnextContext(); return ctx_r6.viewDetails(plan_r4); });
    i0.ɵɵelement(22, "i", 51);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(23, "button", 52);
    i0.ɵɵlistener("click", function TreatmentPlansComponent_tr_66_Template_button_click_23_listener() { const restoredCtx = i0.ɵɵrestoreView(_r7); const plan_r4 = restoredCtx.$implicit; const ctx_r8 = i0.ɵɵnextContext(); return ctx_r8.editPlan(plan_r4); });
...
function TreatmentPlansComponent_tr_67_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "tr");
...
function TreatmentPlansComponent_div_69_div_8_div_44_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r10.selectedPlan.description);
} }
function TreatmentPlansComponent_div_69_div_8_button_46_Template(rf, ctx) { if (rf & 1) {
    const _r13 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 78);
    i0.ɵɵlistener("click", function TreatmentPlansComponent_div_69_div_8_button_46_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r13); const ctx_r12 = i0.ɵɵnextContext(3); return ctx_r12.markAsCompleted(ctx_r12.selectedPlan); });
    i0.ɵɵelement(1, "i", 79);
    i0.ɵɵtext(2, " Marquer comme termin\u00E9 ");
    i0.ɵɵelementEnd();
} }
function TreatmentPlansComponent_div_69_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(34, "span", 48);
    i0.ɵɵtext(35);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(36, "div", 65);
    i0.ɵɵelementStart(37, "label");
    i0.ɵɵtext(38, "Progression");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(39, "div", 69);
    i0.ɵɵelementStart(40, "div", 70);
    i0.ɵɵelement(41, "div", 71);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(44, TreatmentPlansComponent_div_69_div_8_div_44_Template, 5, 1, "div", 73);
    i0.ɵɵelementStart(45, "div", 74);
    i0.ɵɵtemplate(46, TreatmentPlansComponent_div_69_div_8_button_46_Template, 3, 0, "button", 75);
    i0.ɵɵelementStart(47, "button", 76);
    i0.ɵɵlistener("click", function TreatmentPlansComponent_div_69_div_8_Template_button_click_47_listener() { i0.ɵɵrestoreView(_r15); const ctx_r14 = i0.ɵɵnextContext(2); return ctx_r14.closePanel(); });
    i0.ɵɵtext(48, " Fermer ");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(ctx_r9.selectedPlan.name);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(ctx_r9.selectedPlan.riskTitle);
    i0.ɵɵadvance(7);
    i0.ɵɵtextInterpolate(ctx_r9.selectedPlan.owner.charAt(0));
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", ctx_r9.selectedPlan.owner, " ");
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(ctx_r9.selectedPlan.domaine || "Non sp\u00E9cifi\u00E9");
    i0.ɵɵadvance(6);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(30, 14, ctx_r9.selectedPlan.dateEcheance, "dd/MM/yyyy"));
    i0.ɵɵadvance(5);
    i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction3(17, _c1, ctx_r9.selectedPlan.status === "Termin\u00E9", ctx_r9.selectedPlan.status === "En cours", ctx_r9.selectedPlan.status === "En retard"));
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", ctx_r9.selectedPlan.status, " ");
    i0.ɵɵadvance(6);
    i0.ɵɵstyleProp("width", ctx_r9.selectedPlan.progress, "%");
    i0.ɵɵproperty("ngClass", i0.ɵɵpureFunction3(21, _c0, ctx_r9.selectedPlan.status === "Termin\u00E9", ctx_r9.selectedPlan.status === "En cours", ctx_r9.selectedPlan.status === "En retard"));
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1("", ctx_r9.selectedPlan.progress, "%");
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r9.selectedPlan.description);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngIf", ctx_r9.selectedPlan.status !== "Termin\u00E9");
} }
function TreatmentPlansComponent_div_69_Template(rf, ctx) { if (rf & 1) {
    const _r17 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 57);
    i0.ɵɵlistener("click", function TreatmentPlansComponent_div_69_Template_div_click_0_listener() { i0.ɵɵrestoreView(_r17); const ctx_r16 = i0.ɵɵnextContext(); return ctx_r16.closePanel(); });
    i0.ɵɵelementStart(1, "div", 58);
    i0.ɵɵlistener("click", function TreatmentPlansComponent_div_69_Template_div_click_1_listener($event) { return $event.stopPropagation(); });
    ...
    i0.ɵɵlistener("click", function TreatmentPlansComponent_div_69_Template_button_click_6_listener() { i0.ɵɵrestoreView(_r17); const ctx_r19 = i0.ɵɵnextContext(); return ctx_r19.closePanel(); });
    i0.ɵɵelement(7, "i", 62);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(8, TreatmentPlansComponent_div_69_div_8_Template, 49, 25, "div", 63);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
TreatmentPlansComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TreatmentPlansComponent, selectors: [["app-treatment-plans"]], decls: 70, vars: 11, consts: [[1, "role-dashboard", "treatment-plans-page"], [1, "page-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "fas", "fa-arrow-left"], [1, "fas", "fa-tasks"], [1, "header-right"], [1, "btn-action", "secondary", 3, "click"], [1, "fas", "fa-sync-alt"], [1, "kpi-row", "mb-4"], [1, "kpi-card", "kpi-total"], [1, "kpi-icon"], [1, "fas", "fa-clipboard-list"], [1, "kpi-value"], [1, "kpi-label"], [1, "kpi-card", "kpi-progress"], [1, "fas", "fa-spinner"], [1, "kpi-card", "kpi-danger"], [1, "fas", "fa-exclamation-triangle"], [1, "kpi-card", "kpi-closed"], [1, "fas", "fa-check-double"], ["class", "module-card premium stats-card mb-4", 4, "ngIf"], [1, "module-card", "premium", "full-width-card"], [1, "card-header-bar"], [1, "fas", "fa-list-check"], [1, "table-container"], [1, "text-right"], [3, "row-selected", 4, "ngFor", "ngForOf"], [4, "ngIf"], [3, "totalItems", "currentPage", "pageSize", "pageChanged"], ["class", "detail-panel-overlay", 3, "click", 4, "ngIf"], [1, "module-card", "premium", "stats-card", "mb-4"], [1, "stats-header"], [1, "fas", "fa-tachometer-alt"], [1, "progress-row"], [1, "progress-item"], [1, "progress-title"], [1, "progress-track"], [1, "progress-fill", "success"], [1, "progress-value"], [1, "progress-fill", "danger"], [1, "plan-name"], [1, "owner-cell"], [1, "owner-avatar"], [1, "progress-cell"], [1, "mini-progress-track"], [1, "mini-progress-fill", 3, "ngClass"], [1, "progress-text"], [1, "status-badge", 3, "ngClass"], [1, "table-actions"], ["title", "Voir d\u00E9tails", 1, "action-btn", "primary", 3, "click"], [1, "fas", "fa-eye"], ["title", "\u00C9diter", 1, "action-btn", "secondary", 3, "click"], [1, "fas", "fa-edit"], ["colspan", "5"], [1, "empty-state"], [1, "fas", "fa-clipboard-check"], [1, "detail-panel-overlay", 3, "click"], [1, "detail-panel", 3, "click"], [1, "panel-header"], [1, "fas", 3, "ngClass"], [1, "close-btn", 3, "click"], [1, "fas", "fa-times"], ["class", "panel-body", 4, "ngIf"], [1, "panel-body"], [1, "detail-section"], [1, "detail-value"], [1, "detail-row"], [1, "owner-avatar", "small"], [1, "detail-progress"], [1, "detail-progress-track"], [1, "detail-progress-fill", 3, "ngClass"], [1, "detail-progress-text"], ["class", "detail-section", 4, "ngIf"], [1, "panel-actions"], ["class", "btn-action primary full", 3, "click", 4, "ngIf"], [1, "btn-action", "secondary", "full", 3, "click"], [1, "detail-value", "desc"], [1, "btn-action", "primary", "full", 3, "click"], [1, "fas", "fa-check"]], template: function TreatmentPlansComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵtext(44, "Termin\u00E9s");
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(45, TreatmentPlansComponent_div_45_Template, 20, 6, "div", 21);
        i0.ɵɵelementStart(46, "div", 22);
        i0.ɵɵelementStart(47, "div", 23);
        i0.ɵɵelementStart(48, "h3");
        i0.ɵɵelement(49, "i", 24);
        i0.ɵɵtext(50, " Suivi des ex\u00E9cutions");
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(51, "div", 25);
        i0.ɵɵelementStart(52, "table");
        i0.ɵɵelementStart(53, "thead");
        i0.ɵɵelementStart(54, "tr");
        i0.ɵɵelementStart(55, "th");
        i0.ɵɵtext(56, "Plan d'action");
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(57, "th");
        i0.ɵɵtext(58, "Responsable");
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(59, "th");
        i0.ɵɵtext(60, "Progression");
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(61, "th");
        i0.ɵɵtext(62, "Statut");
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(63, "th", 26);
        i0.ɵɵtext(64, "Actions");
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(65, "tbody");
        i0.ɵɵtemplate(66, TreatmentPlansComponent_tr_66_Template, 25, 19, "tr", 27);
        i0.ɵɵtemplate(67, TreatmentPlansComponent_tr_67_Template, 6, 0, "tr", 28);
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(68, "app-pagination", 29);
        i0.ɵɵlistener("pageChanged", function TreatmentPlansComponent_Template_app_pagination_pageChanged_68_listener($event) { return ctx.onPageChanged($event); });
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(69, TreatmentPlansComponent_div_69_Template, 9, 3, "div", 30);
        i0.ɵɵelementEnd();
    } if (rf & 2) {
        i0.ɵɵadvance(21);
