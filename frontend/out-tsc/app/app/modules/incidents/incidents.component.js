...
function IncidentsComponent_tr_74_button_20_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function IncidentsComponent_tr_74_button_20_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r16); const incident_r11 = i0.ɵɵnextContext().$implicit; const ctx_r14 = i0.ɵɵnextContext(); return ctx_r14.openEditModal(incident_r11); });
    i0.ɵɵelement(1, "i", 41);
    i0.ɵɵelementEnd();
} }
function IncidentsComponent_tr_74_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function IncidentsComponent_tr_74_Template_button_click_18_listener() { const restoredCtx = i0.ɵɵrestoreView(_r18); const incident_r11 = restoredCtx.$implicit; const ctx_r17 = i0.ɵɵnextContext(); return ctx_r17.openDetailsModal(incident_r11); });
    i0.ɵɵelement(19, "i", 38);
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(20, IncidentsComponent_tr_74_button_20_Template, 2, 0, "button", 39);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function IncidentsComponent_app_modal_77_p_21_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate(ctx_r20.importMessage);
} }
function IncidentsComponent_app_modal_77_div_22_p_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p");
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const warning_r28 = ctx.$implicit;
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate(warning_r28);
} }
function IncidentsComponent_app_modal_77_div_22_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 79);
    i0.ɵɵtemplate(1, IncidentsComponent_app_modal_77_div_22_p_1_Template, 2, 1, "p", 24);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r21 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", ctx_r21.importWarnings);
} }
function IncidentsComponent_app_modal_77_div_23_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r22.importPreview);
} }
function IncidentsComponent_app_modal_77_option_46_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "option", 17);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const d_r29 = ctx.$implicit;
    i0.ɵɵproperty("value", d_r29.id);
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate(d_r29.nom);
} }
function IncidentsComponent_app_modal_77_option_77_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "option", 17);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const r_r30 = ctx.$implicit;
    i0.ɵɵproperty("value", r_r30.id);
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate2("", r_r30.titre, " (", r_r30.niveauRisque, ")");
} }
function IncidentsComponent_app_modal_77_i_90_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 81);
} }
function IncidentsComponent_app_modal_77_i_91_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 82);
} }
function IncidentsComponent_app_modal_77_Template(rf, ctx) { if (rf & 1) {
    const _r32 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "app-modal", 44);
    i0.ɵɵlistener("close", function IncidentsComponent_app_modal_77_Template_app_modal_close_0_listener() { i0.ɵɵrestoreView(_r32); const ctx_r31 = i0.ɵɵnextContext(); return ctx_r31.showCreateModal = false; });
    i0.ɵɵelementStart(1, "div", 45, 46);
    i0.ɵɵelementStart(3, "form", 47);
    i0.ɵɵlistener("ngSubmit", function IncidentsComponent_app_modal_77_Template_form_ngSubmit_3_listener() { i0.ɵɵrestoreView(_r32); const ctx_r33 = i0.ɵɵnextContext(); return ctx_r33.submitIncident(); });
    ...
    i0.ɵɵlistener("change", function IncidentsComponent_app_modal_77_Template_input_change_11_listener($event) { i0.ɵɵrestoreView(_r32); const ctx_r34 = i0.ɵɵnextContext(); return ctx_r34.onImportFileSelected($event); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(12, "input", 52);
    i0.ɵɵlistener("change", function IncidentsComponent_app_modal_77_Template_input_change_12_listener($event) { i0.ɵɵrestoreView(_r32); const ctx_r35 = i0.ɵɵnextContext(); return ctx_r35.onImportFileSelected($event); });
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(21, IncidentsComponent_app_modal_77_p_21_Template, 2, 1, "p", 56);
    i0.ɵɵtemplate(22, IncidentsComponent_app_modal_77_div_22_Template, 2, 1, "div", 57);
    i0.ɵɵtemplate(23, IncidentsComponent_app_modal_77_div_23_Template, 5, 1, "div", 58);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(81, "div", 69);
    i0.ɵɵelementStart(82, "input", 70);
    i0.ɵɵlistener("change", function IncidentsComponent_app_modal_77_Template_input_change_82_listener($event) { i0.ɵɵrestoreView(_r32); const ctx_r36 = i0.ɵɵnextContext(); return ctx_r36.onFileSelected($event); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(83, "div", 71);
    i0.ɵɵelement(84, "i", 72);
    i0.ɵɵtext(85);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(86, "div", 73);
    i0.ɵɵelementStart(87, "button", 74);
    i0.ɵɵlistener("click", function IncidentsComponent_app_modal_77_Template_button_click_87_listener() { i0.ɵɵrestoreView(_r32); const ctx_r37 = i0.ɵɵnextContext(); return ctx_r37.showCreateModal = false; });
    i0.ɵɵtext(88, "Annuler");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(89, "button", 75);
    i0.ɵɵtemplate(90, IncidentsComponent_app_modal_77_i_90_Template, 1, 0, "i", 76);
    i0.ɵɵtemplate(91, IncidentsComponent_app_modal_77_i_91_Template, 1, 0, "i", 77);
...
function IncidentsComponent_app_modal_78_div_1_ng_container_25_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r42.selectedIncident.domaine);
} }
function IncidentsComponent_app_modal_78_div_1_ng_container_25_div_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 90);
    i0.ɵɵelementStart(1, "span", 87);
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵproperty("ngClass", ctx_r43.getNiveauClass(ctx_r43.selectedIncident));
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", ctx_r43.selectedIncident.niveauRisqueLabel || ctx_r43.levelLabelMap[ctx_r43.selectedIncident.niveauRisque] || ctx_r43.selectedIncident.niveauRisque, " ");
} }
function IncidentsComponent_app_modal_78_div_1_ng_container_25_div_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 90);
    i0.ɵɵelementStart(1, "span", 87);
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r44.selectedIncident.macroProcessus);
} }
function IncidentsComponent_app_modal_78_div_1_ng_container_25_div_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 90);
    i0.ɵɵelementStart(1, "span", 87);
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r45.selectedIncident.processus);
} }
function IncidentsComponent_app_modal_78_div_1_ng_container_25_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(ctx_r46.selectedIncident.planActionTraitement);
} }
function IncidentsComponent_app_modal_78_div_1_ng_container_25_div_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 90);
    i0.ɵɵelementStart(1, "span", 87);
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(5, 1, ctx_r47.selectedIncident.dateEcheance, "dd/MM/yyyy"));
} }
function IncidentsComponent_app_modal_78_div_1_ng_container_25_div_8_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 86);
    i0.ɵɵelementStart(1, "span", 87);
    i0.ɵɵtext(2, "Risque Associe");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "p", 97);
    i0.ɵɵelement(4, "i", 98);
    i0.ɵɵtext(5);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate1(" ", ctx_r48.getRiskTitle(ctx_r48.selectedIncident.riskId), " ");
} }
function IncidentsComponent_app_modal_78_div_1_ng_container_25_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementContainerStart(0);
    i0.ɵɵelement(1, "div", 94);
    i0.ɵɵtemplate(2, IncidentsComponent_app_modal_78_div_1_ng_container_25_div_2_Template, 5, 1, "div", 95);
    i0.ɵɵtemplate(3, IncidentsComponent_app_modal_78_div_1_ng_container_25_div_3_Template, 6, 2, "div", 95);
    i0.ɵɵtemplate(4, IncidentsComponent_app_modal_78_div_1_ng_container_25_div_4_Template, 5, 1, "div", 95);
    i0.ɵɵtemplate(5, IncidentsComponent_app_modal_78_div_1_ng_container_25_div_5_Template, 5, 1, "div", 95);
    i0.ɵɵtemplate(6, IncidentsComponent_app_modal_78_div_1_ng_container_25_div_6_Template, 5, 1, "div", 92);
    i0.ɵɵtemplate(7, IncidentsComponent_app_modal_78_div_1_ng_container_25_div_7_Template, 6, 4, "div", 95);
    i0.ɵɵtemplate(8, IncidentsComponent_app_modal_78_div_1_ng_container_25_div_8_Template, 6, 1, "div", 92);
    i0.ɵɵelementContainerEnd();
} if (rf & 2) {
    const ctx_r40 = i0.ɵɵnextContext(3);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngIf", ctx_r40.selectedIncident.domaine);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r40.selectedIncident.niveauRisque);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r40.selectedIncident.macroProcessus);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r40.selectedIncident.processus);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r40.selectedIncident.planActionTraitement);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r40.selectedIncident.dateEcheance);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r40.selectedIncident.riskId);
} }
function IncidentsComponent_app_modal_78_div_1_div_26_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 86);
    i0.ɵɵelementStart(1, "span", 87);
    i0.ɵɵtext(2, "Piece Jointe");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "a", 99);
    ...
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("href", ctx_r41.environment.serverUrl + "/" + ctx_r41.selectedIncident.pieceJointe + ctx_r41.authQueryToken, i0.ɵɵsanitizeUrl);
} }
function IncidentsComponent_app_modal_78_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(16, "p", 91);
    i0.ɵɵtext(17);
    i0.ɵɵpipe(18, "date");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(19, "div", 90);
    i0.ɵɵelementStart(20, "span", 87);
    i0.ɵɵtext(21, "Statut");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(22, "p", 91);
    i0.ɵɵelementStart(23, "span", 35);
    i0.ɵɵtext(24);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(25, IncidentsComponent_app_modal_78_div_1_ng_container_25_Template, 9, 7, "ng-container", 25);
    i0.ɵɵtemplate(26, IncidentsComponent_app_modal_78_div_1_div_26_Template, 6, 1, "div", 92);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(27, "div", 73);
    i0.ɵɵelementStart(28, "button", 93);
    i0.ɵɵlistener("click", function IncidentsComponent_app_modal_78_div_1_Template_button_click_28_listener() { i0.ɵɵrestoreView(_r50); const ctx_r49 = i0.ɵɵnextContext(2); return ctx_r49.showDetailsModal = false; });
    i0.ɵɵtext(29, "Fermer");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵadvance(7);
    i0.ɵɵtextInterpolate(ctx_r38.selectedIncident.titre);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(ctx_r38.selectedIncident.description);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(18, 7, ctx_r38.selectedIncident.dateSurvenance, "dd/MM/yyyy"));
    i0.ɵɵadvance(6);
    i0.ɵɵproperty("ngClass", ctx_r38.getStatusClass(ctx_r38.selectedIncident));
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate(ctx_r38.selectedIncident.statutLabel || ctx_r38.statusLabelMap[ctx_r38.selectedIncident.statut] || ctx_r38.selectedIncident.statut);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r38.selectedIncident.domaine || ctx_r38.selectedIncident.niveauRisque || ctx_r38.selectedIncident.planActionTraitement);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngIf", ctx_r38.selectedIncident.pieceJointe);
} }
function IncidentsComponent_app_modal_78_Template(rf, ctx) { if (rf & 1) {
    const _r52 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "app-modal", 83);
    i0.ɵɵlistener("close", function IncidentsComponent_app_modal_78_Template_app_modal_close_0_listener() { i0.ɵɵrestoreView(_r52); const ctx_r51 = i0.ɵɵnextContext(); return ctx_r51.showDetailsModal = false; });
    i0.ɵɵtemplate(1, IncidentsComponent_app_modal_78_div_1_Template, 30, 10, "div", 84);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function IncidentsComponent_app_modal_79_option_26_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "option", 17);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const d_r58 = ctx.$implicit;
    i0.ɵɵproperty("value", d_r58.id);
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate(d_r58.nom);
} }
function IncidentsComponent_app_modal_79_option_57_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "option", 17);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const r_r59 = ctx.$implicit;
    i0.ɵɵproperty("value", r_r59.id);
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate2("", r_r59.titre, " (", r_r59.niveauRisque, ")");
} }
function IncidentsComponent_app_modal_79_i_76_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 81);
} }
function IncidentsComponent_app_modal_79_i_77_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 82);
} }
function IncidentsComponent_app_modal_79_Template(rf, ctx) { if (rf & 1) {
    const _r61 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "app-modal", 101);
    i0.ɵɵlistener("close", function IncidentsComponent_app_modal_79_Template_app_modal_close_0_listener() { i0.ɵɵrestoreView(_r61); const ctx_r60 = i0.ɵɵnextContext(); return ctx_r60.showEditModal = false; });
    i0.ɵɵelementStart(1, "div", 45, 46);
    i0.ɵɵelementStart(3, "form", 47);
    i0.ɵɵlistener("ngSubmit", function IncidentsComponent_app_modal_79_Template_form_ngSubmit_3_listener() { i0.ɵɵrestoreView(_r61); const ctx_r62 = i0.ɵɵnextContext(); return ctx_r62.updateIncident(); });
    ...
    i0.ɵɵtext(29, "Niveau");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(30, "select", 66);
    ...
    i0.ɵɵelementStart(48, "span", 60);
    i0.ɵɵtext(49, "*");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelement(50, "input", 67);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(51, "div", 59);
    i0.ɵɵelementStart(52, "label");
    i0.ɵɵtext(53, "Lien avec un Risque (Optionnel)");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(54, "select", 68);
    i0.ɵɵelementStart(55, "option", 17);
    i0.ɵɵtext(56, "Aucun lien direct");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(57, IncidentsComponent_app_modal_79_option_57_Template, 2, 3, "option", 65);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(58, "div", 59);
    i0.ɵɵelementStart(59, "label");
    i0.ɵɵtext(60, "Statut ");
    i0.ɵɵelementStart(61, "span", 60);
    i0.ɵɵtext(62, "*");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(63, "select", 105);
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(72, "div", 73);
    i0.ɵɵelementStart(73, "button", 74);
    i0.ɵɵlistener("click", function IncidentsComponent_app_modal_79_Template_button_click_73_listener() { i0.ɵɵrestoreView(_r61); const ctx_r63 = i0.ɵɵnextContext(); return ctx_r63.showEditModal = false; });
    i0.ɵɵtext(74, "Annuler");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(75, "button", 75);
    i0.ɵɵtemplate(76, IncidentsComponent_app_modal_79_i_76_Template, 1, 0, "i", 76);
    i0.ɵɵtemplate(77, IncidentsComponent_app_modal_79_i_77_Template, 1, 0, "i", 77);
...
IncidentsComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: IncidentsComponent, selectors: [["app-incidents"]], decls: 80, vars: 34, consts: [[1, "incidents-page"], [1, "page-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "fas", "fa-arrow-left"], [1, "fas", "fa-exclamation-triangle"], [1, "header-actions"], ["class", "btn-primary", 3, "click", 4, "ngIf"], [1, "content-container"], [1, "filters-bar", "premium", "mb-4"], [1, "filter-controls"], [1, "filter-group"], [1, "fas", "fa-search"], ["type", "text", "placeholder", "Rechercher...", 3, "ngModel", "ngModelChange"], [1, "fas", "fa-tasks"], [3, "ngModel", "ngModelChange", "change"], ["value", ""], [3, "value"], [1, "fas", "fa-layer-group"], ["class", "btn-reset", 3, "click", 4, "ngIf"], [1, "results-info"], [1, "count-tag"], [1, "risks-card"], [1, "risks-table"], [4, "ngFor", "ngForOf"], [4, "ngIf"], [3, "totalItems", "currentPage", "pageSize", "pageChanged"], ["title", "Declarer un Nouvel Incident", 3, "close", 4, "ngIf"], ["title", "Details de l'incident", 3, "close", 4, "ngIf"], ["title", "Editer l'incident", 3, "close", 4, "ngIf"], [1, "btn-primary", 3, "click"], [1, "fas", "fa-plus"], [1, "btn-reset", 3, "click"], [1, "fas", "fa-undo"], [1, "td-title"], [1, "badge", 3, "ngClass"], [1, "actions-cell"], ["title", "Voir details", 1, "action-btn", "btn-view", 3, "click"], [1, "fas", "fa-eye"], ["class", "action-btn btn-edit", "title", "Editer l'incident", 3, "click", 4, "ngIf"], ["title", "Editer l'incident", 1, "action-btn", "btn-edit", 3, "click"], [1, "fas", "fa-edit"], ["colspan", "5", 1, "empty-state"], [1, "fas", "fa-inbox"], ["title", "Declarer un Nouvel Incident", 3, "close"], ["modal-body", "", 1, "modal-form"], ["projected", ""], [3, "formGroup", "ngSubmit"], [1, "import-box", "mb-3"], [1, "import-box-copy"], [1, "import-box-actions"], ["type", "file", "id", "incidentCreateImportInput", "hidden", "", "accept", ".xls,.xlsx,.xlsm,.pdf,.jpg,.jpeg,.png", 3, "change"], ["type", "file", "id", "incidentCreateScanInput", "hidden", "", "accept", "image/*", "capture", "environment", 3, "change"], ["for", "incidentCreateImportInput", 1, "btn-secondary", "import-trigger"], [1, "fas"], ["for", "incidentCreateScanInput", 1, "btn-secondary", "import-trigger", "scan-trigger"], ["class", "import-feedback", 4, "ngIf"], ["class", "import-warning-list", 4, "ngIf"], ["class", "import-preview", 4, "ngIf"], [1, "form-group", "mb-3"], [1, "text-danger"], ["type", "text", "formControlName", "titre", "placeholder", "Ex: Panne de serveur principal", 1, "finput"], ["formControlName", "description", "rows", "4", "placeholder", "Details de l'incident...", 1, "finput"], ["type", "text", "formControlName", "domaine", "placeholder", "Ex: Informatique, Ressources Humaines...", 1, "finput"], ["formControlName", "departementId", 1, "finput"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "niveauRisque", 1, "finput"], ["type", "date", "formControlName", "dateSurvenance", 1, "finput"], ["formControlName", "riskId", 1, "finput"], [1, "file-upload-box"], ["type", "file", "accept", ".xls,.xlsx,.xlsm,.pdf,.docx,.jpg,.jpeg,.png", 1, "file-input", 3, "change"], [1, "file-upload-label"], [1, "fas", "fa-upload"], [1, "form-footer"], ["type", "button", 1, "btn-cancel", 3, "click"], ["type", "submit", 1, "btn-save", 3, "disabled"], ["class", "fas fa-save", 4, "ngIf"], ["class", "fas fa-spinner fa-spin", 4, "ngIf"], [1, "import-feedback"], [1, "import-warning-list"], [1, "import-preview"], [1, "fas", "fa-save"], [1, "fas", "fa-spinner", "fa-spin"], ["title", "Details de l'incident", 3, "close"], ["modal-body", "", "class", "modal-form", 4, "ngIf"], [1, "details-grid"], [1, "detail-block", "full"], [1, "detail-label"], [1, "detail-value", "title"], [1, "detail-value", 2, "white-space", "pre-wrap"], [1, "detail-block"], [1, "detail-value"], ["class", "detail-block full", 4, "ngIf"], [1, "btn-cancel", 3, "click"], [1, "detail-block", "full", "hr-divider"], ["class", "detail-block", 4, "ngIf"], [1, "detail-value", 2, "white-space", "pre-wrap", "background", "#f9fbfc", "padding", "10px", "border-radius", "6px", "border", "1px solid #e1e8ed"], [1, "detail-value", "text-primary", "font-weight-bold"], [1, "fas", "fa-link", "mr-2"], ["target", "_blank", 1, "doc-link", 3, "href"], [1, "fas", "fa-download"], ["title", "Editer l'incident", 3, "close"], ["type", "text", "formControlName", "titre", 1, "finput"], ["formControlName", "description", "rows", "4", 1, "finput"], ["type", "text", "formControlName", "domaine", 1, "finput"], ["formControlName", "statut", 1, "finput"]], template: function IncidentsComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(76, "app-pagination", 26);
        i0.ɵɵlistener("pageChanged", function IncidentsComponent_Template_app_pagination_pageChanged_76_listener($event) { return ctx.onPageChanged($event); });
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(77, IncidentsComponent_app_modal_77_Template, 93, 42, "app-modal", 27);
        i0.ɵɵtemplate(78, IncidentsComponent_app_modal_78_Template, 2, 1, "app-modal", 28);
        i0.ɵɵtemplate(79, IncidentsComponent_app_modal_79_Template, 79, 28, "app-modal", 29);
        i0.ɵɵelementEnd();
    } if (rf & 2) {
        i0.ɵɵadvance(12);
        ...
        i0.ɵɵadvance(21);
        i0.ɵɵproperty("ngForOf", ctx.paginatedIncidents);
        i0.ɵɵadvance(1);
