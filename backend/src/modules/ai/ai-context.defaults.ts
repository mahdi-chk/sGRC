...
export const DEFAULT_AI_CONTEXTS: DefaultAIContext[] = [
    ...
    },
    {
        name: 'compliance_framework_import',
        type: 'instruction',
        content: 'Tout le contenu doit etre en FRANCAIS. Retourne UNIQUEMENT un objet JSON valide avec EXACTEMENT ce schema : {"framework":{"code":"string court","name":"nom officiel","version":"version ou annee sinon 1.0","jurisdiction":"string ou null","description":"resume court","status":"draft"},"requirements":[{"code":"code de l exigence","title":"titre propre","description":"description complete de l exigence avec obligations, criteres ou controles; jamais seulement le titre","chapter":"chapitre/article ou null","orderIndex":1,"applicability":"applicable","status":"active","weight":1}]}. Extrais les donnees du CADRE depuis le titre, le nom de norme, la version/date, la juridiction et le resume du document. Extrais les EXIGENCES une par une avec leur code officiel si disponible, un titre court, puis une description detaillee issue du texte associe jusqu a l exigence suivante. Nettoie le bruit OCR, les entetes, pieds de page et tables des matieres. Si un code manque, genere REQ-1, REQ-2, etc. N invente pas de description absente; utilise null si le document ne donne aucun contenu. N ajoute aucun texte hors JSON.',
    },
    {
