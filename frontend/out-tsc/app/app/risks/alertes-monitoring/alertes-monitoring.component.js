...
function AlertesMonitoringComponent_div_52_div_1_i_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 18);
} }
function AlertesMonitoringComponent_div_52_div_1_i_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 16);
} }
function AlertesMonitoringComponent_div_52_div_1_i_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 46);
} }
const _c0 = function (a0, a1, a2) { return { "alert-critical": a0, "alert-warning": a1, "alert-info": a2 }; };
function AlertesMonitoringComponent_div_52_div_1_Template(rf, ctx) { if (rf & 1) {
    const _r9 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 32);
    i0.ɵɵelementStart(1, "div", 33);
    i0.ɵɵtemplate(2, AlertesMonitoringComponent_div_52_div_1_i_2_Template, 1, 0, "i", 34);
    i0.ɵɵtemplate(3, AlertesMonitoringComponent_div_52_div_1_i_3_Template, 1, 0, "i", 35);
    i0.ɵɵtemplate(4, AlertesMonitoringComponent_div_52_div_1_i_4_Template, 1, 0, "i", 36);
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵlistener("click", function AlertesMonitoringComponent_div_52_div_1_Template_button_click_12_listener() { const restoredCtx = i0.ɵɵrestoreView(_r9); const alert_r4 = restoredCtx.$implicit; const ctx_r8 = i0.ɵɵnextContext(2); return ctx_r8.markAsTreated(alert_r4); });
    i0.ɵɵelement(13, "i", 43);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(14, "button", 44);
    i0.ɵɵlistener("click", function AlertesMonitoringComponent_div_52_div_1_Template_button_click_14_listener() { const restoredCtx = i0.ɵɵrestoreView(_r9); const alert_r4 = restoredCtx.$implicit; const ctx_r10 = i0.ɵɵnextContext(2); return ctx_r10.openEmailModal(alert_r4); });
...
function AlertesMonitoringComponent_div_52_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 30);
    i0.ɵɵtemplate(1, AlertesMonitoringComponent_div_52_div_1_Template, 16, 10, "div", 31);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function AlertesMonitoringComponent_div_54_div_2_div_12_Template(rf, ctx) { if (rf & 1) {
...
function AlertesMonitoringComponent_div_54_div_2_i_17_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 66);
} }
function AlertesMonitoringComponent_div_54_div_2_i_18_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "i", 45);
} }
function AlertesMonitoringComponent_div_54_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(12, AlertesMonitoringComponent_div_54_div_2_div_12_Template, 3, 1, "div", 58);
    i0.ɵɵelementStart(13, "div", 59);
    i0.ɵɵelementStart(14, "button", 60);
    i0.ɵɵlistener("click", function AlertesMonitoringComponent_div_54_div_2_Template_button_click_14_listener() { i0.ɵɵrestoreView(_r17); const ctx_r16 = i0.ɵɵnextContext(2); return ctx_r16.closeEmailModal(); });
    i0.ɵɵtext(15, " Annuler ");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(16, "button", 61);
    i0.ɵɵlistener("click", function AlertesMonitoringComponent_div_54_div_2_Template_button_click_16_listener() { i0.ɵɵrestoreView(_r17); const ctx_r18 = i0.ɵɵnextContext(2); return ctx_r18.confirmSendEmail(); });
    i0.ɵɵtemplate(17, AlertesMonitoringComponent_div_54_div_2_i_17_Template, 1, 0, "i", 62);
    i0.ɵɵtemplate(18, AlertesMonitoringComponent_div_54_div_2_i_18_Template, 1, 0, "i", 63);
    i0.ɵɵtext(19);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
...
function AlertesMonitoringComponent_div_54_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function AlertesMonitoringComponent_div_54_div_3_Template_button_click_8_listener() { i0.ɵɵrestoreView(_r20); const ctx_r19 = i0.ɵɵnextContext(2); return ctx_r19.closeEmailModal(); });
    i0.ɵɵtext(9, " Fermer ");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
...
function AlertesMonitoringComponent_div_54_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function AlertesMonitoringComponent_div_54_Template_div_click_0_listener() { i0.ɵɵrestoreView(_r22); const ctx_r21 = i0.ɵɵnextContext(); return ctx_r21.closeEmailModal(); });
    i0.ɵɵelementStart(1, "div", 50);
    i0.ɵɵlistener("click", function AlertesMonitoringComponent_div_54_Template_div_click_1_listener($event) { return $event.stopPropagation(); });
    i0.ɵɵtemplate(2, AlertesMonitoringComponent_div_54_div_2_Template, 20, 7, "div", 51);
    i0.ɵɵtemplate(3, AlertesMonitoringComponent_div_54_div_3_Template, 10, 0, "div", 52);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
AlertesMonitoringComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AlertesMonitoringComponent, selectors: [["app-alertes-monitoring"]], decls: 55, vars: 7, consts: [[1, "role-dashboard", "alertes-monitoring-page"], [1, "page-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "fas", "fa-arrow-left"], [1, "fas", "fa-shield-alt"], [1, "header-right"], [1, "btn-action", "primary", 3, "click"], [1, "fas", "fa-sync-alt"], [1, "kpi-row", "mb-4"], [1, "kpi-card", "kpi-danger"], [1, "kpi-icon"], [1, "fas", "fa-bell"], [1, "kpi-value"], [1, "kpi-label"], [1, "kpi-card", "kpi-total"], [1, "fas", "fa-exclamation-triangle"], [1, "kpi-card", "kpi-progress"], [1, "fas", "fa-exclamation-circle"], [1, "kpi-card", "kpi-closed"], [1, "fas", "fa-clock"], [1, "module-card", "premium", "full-width-card"], [1, "card-header-bar"], [1, "fas", "fa-stream"], [1, "live-dot"], [1, "ping"], [1, "dot"], ["class", "alerts-list", 4, "ngIf"], ["class", "empty-state", 4, "ngIf"], ["class", "modal-overlay", 3, "click", 4, "ngIf"], [1, "alerts-list"], ["class", "alert-item", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "alert-item", 3, "ngClass"], [1, "alert-icon-container"], ["class", "fas fa-exclamation-circle", 4, "ngIf"], ["class", "fas fa-exclamation-triangle", 4, "ngIf"], ["class", "fas fa-info-circle", 4, "ngIf"], [1, "alert-body"], [1, "alert-message"], [1, "alert-time"], [1, "far", "fa-clock"], [1, "alert-actions"], ["title", "Marquer comme trait\u00E9", 1, "action-btn", "success", 3, "click"], [1, "fas", "fa-check"], ["title", "Envoyer un email", 1, "action-btn", "info", 3, "click"], [1, "fas", "fa-paper-plane"], [1, "fas", "fa-info-circle"], [1, "empty-state"], [1, "fas", "fa-check-circle"], [1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click"], [4, "ngIf"], ["class", "success-state", 4, "ngIf"], [1, "modal-icon"], [1, "fas", "fa-envelope"], [1, "modal-desc"], [1, "modal-risk-name"], [1, "modal-note"], ["class", "modal-error", 4, "ngIf"], [1, "modal-actions"], [1, "btn-action", "secondary", 3, "disabled", "click"], [1, "btn-action", "primary", 3, "disabled", "click"], ["class", "fas fa-spinner fa-spin", 4, "ngIf"], ["class", "fas fa-paper-plane", 4, "ngIf"], [1, "modal-error"], [1, "fas", "fa-times-circle"], [1, "fas", "fa-spinner", "fa-spin"], [1, "success-state"], [1, "modal-icon", "success"]], template: function AlertesMonitoringComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵtext(48, " Flux d'alertes en temps r\u00E9el");
        i0.ɵɵelementEnd();
        i0.ɵɵelementStart(49, "span", 24);
        i0.ɵɵelement(50, "span", 25);
        i0.ɵɵelement(51, "span", 26);
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(52, AlertesMonitoringComponent_div_52_Template, 2, 1, "div", 27);
        i0.ɵɵtemplate(53, AlertesMonitoringComponent_div_53_Template, 4, 0, "div", 28);
        i0.ɵɵelementEnd();
        i0.ɵɵtemplate(54, AlertesMonitoringComponent_div_54_Template, 4, 2, "div", 29);
        i0.ɵɵelementEnd();
    } if (rf & 2) {
        i0.ɵɵadvance(20);
