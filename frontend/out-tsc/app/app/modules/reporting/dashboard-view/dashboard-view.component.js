...
function DashboardViewComponent_div_16_div_32_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate2("", kpi_r9.value, "", kpi_r9.unit, "");
    i0.ɵɵadvance(2);
    i0.ɵɵstyleProp("width", ctx_r2.getKpiProgress(kpi_r9.id), "%");
} }
function DashboardViewComponent_div_16_div_71_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 65);
    i0.ɵɵelement(1, "span", 66);
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const levelCode_r10 = ctx.$implicit;
    const ctx_r3 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("ngClass", ctx_r3.getRiskLevelClass(levelCode_r10));
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate2(" ", ctx_r3.getRiskLevelLabel(levelCode_r10), " (", ctx_r3.getRiskLevelCount(levelCode_r10), ") ");
} }
function DashboardViewComponent_div_16_div_82_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate(ctx_r4.getRiskStatusLabel(status_r11));
} }
function DashboardViewComponent_div_16_ng_container_83_div_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 70);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const status_r14 = ctx.$implicit;
    const level_r12 = i0.ɵɵnextContext().$implicit;
    const ctx_r13 = i0.ɵɵnextContext(2);
    i0.ɵɵproperty("ngClass", ctx_r13.getMatrixTone(level_r12, status_r14));
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", ctx_r13.getMatrixCount(level_r12, status_r14), " ");
} }
function DashboardViewComponent_div_16_ng_container_83_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementContainerStart(0);
    i0.ɵɵelementStart(1, "div", 68);
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(3, DashboardViewComponent_div_16_ng_container_83_div_3_Template, 2, 2, "div", 69);
    i0.ɵɵelementContainerEnd();
} if (rf & 2) {
    const level_r12 = ctx.$implicit;
    const ctx_r5 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r5.getRiskLevelLabel(level_r12));
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", ctx_r5.riskStatusOrder);
} }
function DashboardViewComponent_div_16_div_90_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r6.getRiskStatusLabel(status_r16));
    i0.ɵɵadvance(2);
    i0.ɵɵstyleProp("width", ctx_r6.getPercent(status_r16.count, ctx_r6.stats.incidents.total), "%");
    i0.ɵɵproperty("ngClass", ctx_r6.getStatusClass(status_r16));
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(status_r16.count);
} }
function DashboardViewComponent_div_16_div_96_Template(rf, ctx) { if (rf & 1) {
    ...
    const risk_r17 = ctx.$implicit;
    const ctx_r7 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngClass", ctx_r7.getRiskLevelClass(risk_r17.niveauRisqueCode || risk_r17.niveauRisque));
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(risk_r17.titre);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate2("", risk_r17.domaine || "General", " \u2022 ", ctx_r7.getRiskStatusLabel(risk_r17.statutLabel || risk_r17.statutCode || risk_r17.statut), "");
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(10, 5, risk_r17.createdAt, "dd/MM"));
} }
function DashboardViewComponent_div_16_div_102_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 76);
    ...
    const incident_r18 = ctx.$implicit;
    const ctx_r8 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(incident_r18.titre);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(ctx_r8.getRiskStatusLabel(incident_r18.statutLabel || incident_r18.statutCode || incident_r18.statut));
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind2(10, 3, incident_r18.createdAt, "dd/MM"));
} }
function DashboardViewComponent_div_16_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(32, DashboardViewComponent_div_16_div_32_Template, 8, 5, "div", 29);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelementStart(65, "div", 39);
    i0.ɵɵelementStart(66, "span", 40);
    i0.ɵɵtext(67);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(68, "span", 41);
    i0.ɵɵtext(69, "Total");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(70, "div", 42);
    i0.ɵɵtemplate(71, DashboardViewComponent_div_16_div_71_Template, 3, 3, "div", 43);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵelement(75, "i", 46);
    i0.ɵɵtext(76, " Apercu matrice de risque");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(77, "button", 47);
    i0.ɵɵlistener("click", function DashboardViewComponent_div_16_Template_button_click_77_listener() { i0.ɵɵrestoreView(_r20); const ctx_r19 = i0.ɵɵnextContext(); return ctx_r19.openRiskMatrix(); });
    i0.ɵɵtext(78, "Ouvrir la matrice");
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(79, "div", 48);
    i0.ɵɵelementStart(80, "div", 49);
    i0.ɵɵtext(81, "Niveau / Statut");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(82, DashboardViewComponent_div_16_div_82_Template, 2, 1, "div", 50);
    i0.ɵɵtemplate(83, DashboardViewComponent_div_16_ng_container_83_Template, 4, 2, "ng-container", 51);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(84, "div", 35);
    i0.ɵɵelementStart(85, "h3");
    i0.ɵɵelement(86, "i", 52);
    i0.ɵɵtext(87, " Statut des incidents");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(88, "div", 53);
    i0.ɵɵelementStart(89, "div", 54);
    i0.ɵɵtemplate(90, DashboardViewComponent_div_16_div_90_Template, 7, 5, "div", 55);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(91, "div", 56);
    i0.ɵɵelementStart(92, "h3");
    i0.ɵɵelement(93, "i", 57);
    i0.ɵɵtext(94, " Risques recents");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(95, "div", 58);
    i0.ɵɵtemplate(96, DashboardViewComponent_div_16_div_96_Template, 11, 8, "div", 59);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(97, "div", 56);
    i0.ɵɵelementStart(98, "h3");
    i0.ɵɵelement(99, "i", 60);
    i0.ɵɵtext(100, " Incidents recents");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(101, "div", 58);
    i0.ɵɵtemplate(102, DashboardViewComponent_div_16_div_102_Template, 11, 6, "div", 59);
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵadvance(9);
    i0.ɵɵproperty("ngForOf", ctx_r1.kpis);
    i0.ɵɵadvance(10);
    i0.ɵɵtextInterpolate(ctx_r1.getStatusCount(ctx_r1.riskStatusOrder[0]));
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(ctx_r1.getStatusCount(ctx_r1.riskStatusOrder[1]));
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(ctx_r1.getStatusCount(ctx_r1.riskStatusOrder[2]));
    i0.ɵɵadvance(5);
    i0.ɵɵtextInterpolate(ctx_r1.getStatusCount(ctx_r1.riskStatusOrder[3]));
    i0.ɵɵadvance(7);
    ...
    i0.ɵɵadvance(11);
    i0.ɵɵproperty("ngForOf", ctx_r1.riskStatusOrder);
    i0.ɵɵadvance(1);
    i0.ɵɵproperty("ngForOf", ctx_r1.riskLevelOrder);
    i0.ɵɵadvance(7);
...
DashboardViewComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DashboardViewComponent, selectors: [["app-dashboard-view"]], decls: 17, vars: 5, consts: [[1, "role-dashboard", "reporting-dashboard", "dashboard-view-page"], [1, "page-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "fas", "fa-arrow-left"], [1, "fas", "fa-chart-line"], [1, "header-right"], [1, "btn-refresh", 3, "disabled", "click"], [1, "fas", "fa-sync-alt"], ["class", "loading-overlay", 4, "ngIf"], ["class", "dashboard-content", 4, "ngIf"], [1, "loading-overlay"], [1, "spinner"], [1, "dashboard-content"], [1, "kpi-row"], [1, "kpi-card", "kpi-risks"], [1, "kpi-icon"], [1, "fas", "fa-exclamation-triangle"], [1, "kpi-info"], [1, "kpi-value"], [1, "kpi-label"], [1, "kpi-card", "kpi-incidents"], [1, "fas", "fa-fire"], [1, "kpi-card", "kpi-audits"], [1, "fas", "fa-clipboard-check"], [1, "insight-grid"], [1, "module-card", "premium", "kpi-detail-card"], [1, "fas", "fa-gauge-high"], [1, "kpi-detail-list"], ["class", "kpi-detail-item", 4, "ngFor", "ngForOf"], [1, "module-card", "premium", "posture-card"], [1, "fas", "fa-shield-halved"], [1, "posture-list"], [1, "posture-item"], [1, "dashboard-grid"], [1, "module-card", "premium", "chart-card"], [1, "fas", "fa-signal"], [1, "chart-container", "donut-wrapper"], [1, "donut-chart"], [1, "donut-inner"], [1, "total"], [1, "sub"], [1, "chart-legend"], ["class", "legend-item", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "module-card", "premium", "matrix-preview-card"], [1, "matrix-card-header"], [1, "fas", "fa-table-cells-large"], [1, "btn-inline", 3, "click"], [1, "matrix-preview-grid"], [1, "matrix-preview-corner"], ["class", "matrix-preview-header", 4, "ngFor", "ngForOf"], [4, "ngFor", "ngForOf"], [1, "fas", "fa-tasks"], [1, "chart-container", "bar-wrapper"], [1, "bar-chart"], ["class", "bar-group", 4, "ngFor", "ngForOf"], [1, "module-card", "premium", "list-card"], [1, "fas", "fa-history"], [1, "item-list"], ["class", "list-item", 4, "ngFor", "ngForOf"], [1, "fas", "fa-bolt"], [1, "kpi-detail-item"], [1, "kpi-detail-top"], [1, "kpi-progress-bar"], [1, "fill"], [1, "legend-item", 3, "ngClass"], [1, "dot"], [1, "matrix-preview-header"], [1, "matrix-preview-header", "row-title"], ["class", "matrix-preview-cell", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "matrix-preview-cell", 3, "ngClass"], [1, "bar-group"], [1, "bar-label"], [1, "bar-track"], [1, "bar-fill", 3, "ngClass"], [1, "bar-value"], [1, "list-item"], [1, "item-icon", 3, "ngClass"], [1, "fas", "fa-shield-alt"], [1, "item-details"], [1, "item-title"], [1, "item-meta"], [1, "item-date"], [1, "item-icon", "warning"], [1, "fas", "fa-exclamation-circle"]], template: function DashboardViewComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        i0.ɵɵtemplate(16, DashboardViewComponent_div_16_Template, 103, 25, "div", 10);
        i0.ɵɵelementEnd();
    } if (rf & 2) {
        i0.ɵɵadvance(12);
